...
// Get the keywords from the search field
        ...
        // Loop through the questions and find those that contain the keywords in the title
        $matches = array();
        foreach ($questions as $question) {
           if (stripos($question['title'], strval($keywords)) !== false) {
                $matches[] = $question;
            }
        }
...
<section>
	...
	<h2>Questions List</h2>
		...
		<?php foreach ($matches as $question): 
